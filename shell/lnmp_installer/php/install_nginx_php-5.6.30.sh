...
sed -i 's,;error_log = log/php-fpm.log,error_log = '$install_dir'/server/php/log/php-fpm.log,g'   $install_dir/server/php/etc/php-fpm.conf
sed -i 's,;slowlog = log/$pool.log.slow,slowlog = '$install_dir'/server/php/log/\$pool.log.slow,g'   $install_dir/server/php/etc/php-fpm.conf
#self start
