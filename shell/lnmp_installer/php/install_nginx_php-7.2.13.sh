...
make install
cd ..
cp ./php-7.2.13/php.ini-production /opt/server/php/etc/php.ini
#adjust php.ini
...
cp /opt/server/php/etc/php-fpm.d/www.conf.default /opt/server/php/etc/php-fpm.d/www.conf
...
#self start
install -v -m755 ./php-7.2.13/sapi/fpm/init.d.php-fpm  /etc/init.d/php-fpm
/etc/init.d/php-fpm start
sleep 5
# add ln for php
ln -s /opt/server/php/bin/php /usr/bin/php
