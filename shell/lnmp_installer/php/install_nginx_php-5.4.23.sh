...
make install
cd ..
cp ./php-5.4.23/php.ini-production /opt/server/php/etc/php.ini
#adjust php.ini
sed -i 's#; extension_dir = \"\.\/\"#extension_dir = "/opt/server/php/lib/php/extensions/no-debug-non-zts-20100525/"#'  /opt/server/php/etc/php.ini
